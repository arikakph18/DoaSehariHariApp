package com.idn.arika.doaseharihariapp
...
import com.idn.arika.doaseharihariapp.adapter.AdapterDoa
import com.idn.arika.doaseharihariapp.model.ModelDoa
...
//        get data
    ...
    private fun getDoaHarian(){
        try {
            ...
            stream.read(buffer)
            stream.close()
            val stResponse = String(buffer, StandardCharsets.UTF_8)
            try {
              val jsonObject = JSONObject(stResponse)
